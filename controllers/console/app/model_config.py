...
from services.clients.http_client import sync_workflow_request
...
class ModelConfigResource(Resource):
    ...
    def post(self, app_model):
        ...
        suggested_questions = new_app_model_config.suggested_questions if new_app_model_config.suggested_questions else "[]"
        features = {
            "opening_statement": new_app_model_config.opening_statement,
            "suggested_questions": json.loads(suggested_questions),
            
        }
        sync_workflow_request(app_id=app_model.id, features=features)
